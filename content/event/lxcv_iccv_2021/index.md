...
summary: In this work, we report progress on a comparative evaluation of self-supervised learning (SSL) and supervised learning (SL) algorithms as pre-training methods for sonar images.
